...
class vimconnector():
    ...
    def new_project_network(self,project_id):
        '''Adds a managemet and control network to VIM (shared)'''
        '''Returns the network identifier'''
        raise NotImplementedError( "Should have implemented this" )
    ...
    def new_project_ema(self, project_id):
        '''Adds a new tenant to VIM'''
        '''Returns the tenant identifier'''
        raise NotImplementedError( "Should have implemented this" )
   
    def delete_tenant(self,tenant_id,mgnt_network_id,ctrl_network_id,EMA_iid):
    ...
    def new_floatingip(self, project_id,vapp_name):
        '''Adds a VM instance to VIM'''
        '''Returns the instance identifier'''
        raise NotImplementedError( "Should have implemented this" )
    def del_floatingip(self, project_id,vapp_name,floating_ip):
        '''Adds a VM instance to VIM'''
        '''Returns the instance identifier'''
        raise NotImplementedError( "Should have implemented this" )
    ...
    def new_project_vminstance(self,project_id, image_id,network_id, description):
        '''Adds a VM instance to VIM
        Params:
